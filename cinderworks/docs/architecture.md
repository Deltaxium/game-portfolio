...
World maps are registered through `worldMaps`. Each map owns its tile array,
display name, `renderProfile`, transition metadata, and random encounter settings.
